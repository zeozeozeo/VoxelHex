...
// #[cfg(feature = "raytracing")]
// use voxelhex::{boxtree::V3c, raytracing::Ray};
...
//     let mut tree = voxelhex::boxtree::BoxTree::<Albedo>::new(TREE_SIZE, BRICK_DIMENSION)
//         .ok()
//         .unwrap();
...
//     use voxelhex::boxtree::types::Albedo;
...
fn main() {
    println!("Please refer to issue #37");
}
